summon villager ~ ~ ~ {Team: wtworlds.defiled_temple, CustomName: {translate: "entity.wtworlds.nun"}, CustomNameVisible: false, Silent: true, equipment: {head: {id: leather_helmet, components: {enchantments: {"wtworlds:entity/nun": 1, protection: 4, vanishing_curse: 1}, unbreakable: {}}}, offhand: {id: bow, components: {item_model: "air", enchantments: {"wtworlds:team/defiled_temple": 1, vanishing_curse: 1}}}}, VillagerData: {profession: "nitwit", type: "taiga", level: 1}, Offers: {Recipes: [\
...
sell: {id: "potion", count: 1, "components": {\
    ...
    {\
        "potion": "mundane",\
        "custom_name": "wtworlds.thought_of_a_friend"\
    },\
    "enchantments":\
    {\
        "wtworlds:bonding": 1\
    }\
}}, maxUses: 12, priceMultiplier: 0.05, rewardExp: true, xp: 15} \
]}}