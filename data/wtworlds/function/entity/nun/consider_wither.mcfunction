...
execute unless entity @n[type=#wtworlds:nun_enemies, type=!#wtworlds:wither_status_immune, distance=..12] run return run function wtworlds:entity/nun/unchannel
