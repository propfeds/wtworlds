...
execute unless entity @n[type=#wtworlds:nun_enemies, type=!wither_skeleton, distance=..12] run return 0
...
execute at @s run function wtworlds:entity/nun/particles_channelling
