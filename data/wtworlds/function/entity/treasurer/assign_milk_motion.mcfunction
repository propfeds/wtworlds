...
data modify storage wtworlds:treasurer.milk motion set from entity @s Pos
tp @s ~ ~ ~
data modify entity @s Motion set from storage wtworlds:treasurer.milk motion
data remove storage wtworlds:treasurer.milk motion
