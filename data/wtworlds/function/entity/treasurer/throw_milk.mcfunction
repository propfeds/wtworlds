...
execute anchored eyes run summon minecraft:armor_stand ^ ^ ^ {Team: wtworlds.defiled_temple, Invisible: 1b, attributes: [{id: "gravity", base: 0.04}, {id: "scale", base: 0.5}], ArmorItems:[{}, {}, {}, {id: milk_bucket, components:{item_model:"wtworlds:milk_bucket_armour_stand", enchantments: {"wtworlds:entity/treasurer/milk_spill":1}, enchantment_glint_override: false}}], ArmorDropChances: [0.0, 0.0, 0.0, 0.0]}
