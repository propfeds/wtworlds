execute store result storage wtworlds:whirlpool.motion x double -0.000025 run data get entity @s Motion[0] 10000
execute store result storage wtworlds:whirlpool.motion y double -0.000025 run data get entity @s Motion[1] 10000
execute store result storage wtworlds:whirlpool.motion z double -0.000025 run data get entity @s Motion[2] 10000
