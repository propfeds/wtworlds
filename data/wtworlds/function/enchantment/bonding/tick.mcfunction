...
execute if predicate wtworlds:enchantment/bonding/mainhand if function wtworlds:enchantment/bonding/check_companion run function wtworlds:enchantment/bonding/give_xp_mainhand
