...
particle dust_color_transition{from_color: [1.0, 0.3, 0.2], scale: 0.35, to_color: [0.3, 0.1, 0.6]} ~ ~ ~ 0.125 0.75 0.125 4 42
particle dust_color_transition{from_color: [1.0, 0.3, 0.2], scale: 0.35, to_color: [0.3, 0.1, 0.6]} ~ ~ ~ 0.5 0.125 0.5 4 18
particle crimson_spore ~ ~-0.25 ~ 0.25 0.5 0.25 0 3
...
particle crimson_spore ~ ~ ~ 0.5 0.25 0.5 0 7
