...
execute if score @s prop.blockFrame matches 1 run return run function prop:blocking/perfect_block
execute if score @s prop.blockFrame matches 6 run return run function prop:blocking/imperfect_block